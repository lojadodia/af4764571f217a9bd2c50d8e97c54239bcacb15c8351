            ...
            <li key="track-orders">
              ...
              {isAuthorize ? (
                <li key="track-orders">
                  <Link
                    href={ROUTES.ORDERS}
                    className={`${!displayHeaderSearch ? (settings?.env?.HEADER_THEME == "dark" ? " text-white " : " text-heading  ") : " text-heading "} dark:text-white flex items-center transition duration-200 no-underline hover:text-primary focus:text-primary`}
                  >
                   MEUS PEDIDOS
                  </Link>
                </li>
