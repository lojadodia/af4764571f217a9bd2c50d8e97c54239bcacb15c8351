...
const RegisterForm = () => {
  ...
  return (
    <div className="py-6 px-5 sm:p-8 bg-white dark:bg-neutral-800 rounded-lg w-screen md:max-w-md h-screen md:h-auto flex flex-col justify-center  dark:border-neutral-700 border">
      ...
      <p className="text-center dark:text-gray text-sm md:text-base leading-relaxed px-2 sm:px-0 text-body mt-4 sm:mt-5 mb-7 sm:mb-10">
      ...
      <div className="flex flex-col items-center justify-center relative text-sm text-heading mt-8 sm:mt-11 mb-6 sm:mb-8">
        ...
        <span className="absolute left-2/4 -top-2.5 px-2 -ml-4 bg-white  dark:bg-neutral-900 dark:text-white">
          Ou
        </span>
      </div>
